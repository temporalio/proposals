...
The Temporal proposal process begins when you create a [proposal issue](./ISSUE_TEMPLATE.md) on this repo. There are some general guidelines we expect all proposal contributors to follow:
...
* Proposal must adhere to our [proposal issue template](./ISSUE_TEMPLATE.md). Reviewing proposals takes time, having a standard form of submission ensures each proposal gets a fair chance.
